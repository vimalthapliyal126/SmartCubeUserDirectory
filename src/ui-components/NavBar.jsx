    ...
    >
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Pas User Directory"
          {...getOverrideProps(overrides, "Pas User Directory")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
      ...
      >
        <Image
          ...
          borderRadius="160px"
          padding="0px 0px 0px 0px"
          src="https://sn-external.thesmartcube.com/Home/images/SmartCube_Logo_Primary_RGB.svg"
      ...
      >
        <Button
          ...
          {...getOverrideProps(overrides, "Button34792738")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="link"
          children="Sign out"
          {...getOverrideProps(overrides, "Button34812758")}
        ></Button>
      </Flex>
    </Flex>
  );
